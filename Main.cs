...
namespace A_Life_converter
{
    class Program
    {
        ...
        static void Snork_weak(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = snork_weak"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Psy_dog(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = psy_dog"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Psy_dog_radar(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = psy_dog_radar"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Tushkano_normal(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = tushkano_normal"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Pseudodog_normal(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = pseudodog_normal"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Pseudodog_strong(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = pseudodog_strong"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Punslinger_flash(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = punslinger_flash"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
        ...
        static void Controller_tubeman(List<string> objects)
        {
            List<string> resultData = new List<string>();
            foreach (string str in objects)
            {
                if (str.Contains("section_name = controller_tubeman"))
                {
                    string st = str.Replace("section_name = ", "");
                    resultData.Add(st);
                    continue;
